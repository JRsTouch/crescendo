...
<main>
	...
	<form enctype="multipart/form-data" action="#" method="post" id="document">
		<fieldset><legend>Enregistrement d'un document</legend>
	...
	<form enctype="multipart/form-data" action="#" method="post" id="image">
		<fieldset><legend>Enregistrement d'une image </legend>
	...
	<form enctype="multipart/form-data" action="#" method="post" id="news">
		<fieldset><legend>Enregistrement d'une news ou d'une actualité de presse</legend>
			<select name="table">
